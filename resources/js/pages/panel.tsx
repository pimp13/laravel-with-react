...
export default function Panel({ dataTest }: { dataTest: string }) {
  ...
  const [formResponse, setFormResponse] = useState<LaravelformResponseForTest>({
    data: {},
    errors: {},
    success: false,
    message: "",
  });
  const [usersData, setUsersData] = useState<UsersDataFromLaravel | null>(null);
...
Panel.layout = (page: React.ReactNode) => <AppLayout>{page}</AppLayout>;
