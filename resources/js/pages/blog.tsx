...
const EmptyState = () => (
  <div className="col-span-full flex flex-col items-center justify-center py-20 text-center">
    ...
    <p className="text-slate-500 max-w-md">
      متأسفانه پستی با این جستجو پیدا نشد. کلمات کلیدی دیگری را امتحان کنید.
    </p>
  </div>
);
...
export default function BlogPostsPage() {
  ...
  const categories = useMemo(() => {
    const cats = Array.from(
      new Map(MOCK_POSTS.map((p) => [p.category.id, p.category])).values(),
    );
    return cats;
  }, []);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center space-y-6">
            ...
            <p className="text-lg md:text-xl text-indigo-100 max-w-2xl mx-auto leading-relaxed">
              آخرین مقالات و آموزش‌های تخصصی در حوزه برنامه‌نویسی، طراحی و
              تکنولوژی
            </p>
